...
RenamedkeysforJoin_node1721884556733 = ApplyMapping.apply(frame=StepTrainerLanding_node1721882712612, mappings=[("sensorreadingtime", "bigint", "sensorreadingtime", "long"), ("serialnumber", "string", "right_serialnumber", "string"), ("distancefromobject", "int", "right_distancefromobject", "int")], transformation_ctx="RenamedkeysforJoin_node1721884556733")
...
StepTrainerTrusted_node1721884614864 = glueContext.getSink(path="s3://loinlt1/step_trainer_trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="StepTrainerTrusted_node1721884614864")
